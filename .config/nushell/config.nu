...
source ~/.config/nushell/plugins/nu_scripts/custom-completions/glow/glow-completions.nu
...
source ~/.config/nushell/plugins/nu_scripts/custom-completions/mysql/mysql-completions.nu
