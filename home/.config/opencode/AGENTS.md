...
1. Resolve library: `pnpx ctx7@latest library <name> "<user's question>"` — use
...
3. Fetch docs: `pnpx ctx7@latest docs <libraryId> "<user's question>"`
...
`pnpx ctx7@latest login` or setting `CONTEXT7_API_KEY` env var for higher
limits. Do not silently fall back to training data.
